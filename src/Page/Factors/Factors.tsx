...
import { fakeFactors } from "../../mock/factors";
      ...
      >
        ...
        <section className="w-full text-right mt-8 flex flex-col gap-2 overflow-y-auto">
          <div className="flex justify-between">
            ...
            <div className="bg-our-choice h-10 p-4 rounded-md flex items-center justify-center w-[120px]">
              تعداد اقلام
            </div>
            <div className="bg-our-choice h-10 p-4 rounded-md flex items-center justify-center w-[120px]">
              وضعیت بدهی
            ...
            {pagedFactors && pagedFactors.length > 0 ? (
              pagedFactors.map((item, index) => (
                ...
                >
                  ...
                  <div className="h-[49px] p-4 rounded-md flex items-center justify-center w-[180px]">
                    {item.receiptCode}
                  </div>
                  <div className="h-[49px] p-4 rounded-md flex items-center justify-center w-[180px]">
                    {new Date(item.createdDate).toLocaleDateString("fa-IR")}
                  </div>
                  <div className="h-[49px] p-4 rounded-md flex items-center justify-center w-[180px] font-semibold">
                    {item.totalAmount
                      .toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                  </div>
                  <div className="h-[49px] p-4 rounded-md flex items-center justify-center w-[120px]">
                    {item.saleCount}
                  </div>
                  <div
                    className="h-[49px] p-4 rounded-md flex items-center justify-center w-[120px]"
                    style={{
